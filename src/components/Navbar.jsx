    ...
    <nav className="sticky top-0 z-50 flex justify-between items-center px-6 py-4 bg-white shadow-lg shadow-purple-300 border-b-2 border-purple-100">
      ...
      <div className="flex justify-start">
        ...
        <div className="flex justify-center flex-1 gap-8 items-center sm:gap-8 mx-2">
          ...
          <NavLink
            to="/explore"
            className={({ isActive }) => isActive ? "font-bold text-purple-700 transition duration-300 flex items-center gap-2 cursor-pointer" : "text-gray-700 hover:text-purple-700 transition duration-300 flex items-center font-medium gap-2 cursor-pointer"}
